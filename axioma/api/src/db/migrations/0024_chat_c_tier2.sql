...
ON CONFLICT (form_id, key) DO NOTHING;--> statement-breakpoint
UPDATE service_subcategories SET form_id = 'form-laptop-request' WHERE id = 'ss-account' AND form_id IS NULL;--> statement-breakpoint
UPDATE services SET sla_id = 'default-sla' WHERE id = 'svc-device' AND sla_id IS NULL;--> statement-breakpoint
