...
import { Input } from "@axioma/ui/components/input";
import { Textarea } from "@axioma/ui/components/textarea";
import { cn } from "@axioma/ui/lib/utils";
import { cva, type VariantProps } from "class-variance-authority";
import type * as React from "react";

function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: a fieldset would impose its own layout and legend semantics on an inline control wrapper
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: see InputGroup above
		// biome-ignore lint/a11y/useKeyWithClickEvents: click forwards focus to the adjacent control; the addon is not itself focusable, and the control it targets is reachable by keyboard on its own
		<div
			role="group"
