...
function initializeAsciify(
	...
	const htmlPaint =
		...
		typeof paintable.requestPaint === "function"
			? {
					ctx: sourceCtx,
					draw: sourceCtx.drawElementImage.bind(sourceCtx),
					request: paintable.requestPaint.bind(paintable),
				}
			: null;
	const htmlInCanvas = htmlPaint !== null;
	...
	if (!contentTexture)
		throw new Error("WebGL content texture could not be created");
	...
	if (!textMaskTexture)
		throw new Error("WebGL text-mask texture could not be created");
